...
<body id="append_parent">
	<div class="bodydiv">
		...
		<div style="width: 90%; margin: 0 auto;">
			<table id="menu">
				<tr>
					<td <?php echo $nowarr[0] ;?>>1.安装开始</td>
					<td <?php echo $nowarr[1] ;?>>2.设置数据库连接信息</td>
					<td <?php echo $nowarr[2] ;?>>3.创建数据库结构</td>
					<td <?php echo $nowarr[3] ;?>>4.添加默认数据</td>
					<td <?php echo $nowarr[4] ;?>>5.安装完成</td>
				</tr>
			</table>